...
import { FileText, Linkedin, Github, Mail, Heart } from "lucide-react"
...
export default function Footer() {
    ...
    return (
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-950 to-cyan-950 -z-10" />
        <div className="absolute inset-0 bg-grid-white/[0.02] -z-10" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-blue-600/10 to-cyan-600/10 rounded-full blur-2xl -z-10" />
