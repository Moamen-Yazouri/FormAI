...
export default function LandingPage() {
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-950">
      {/* Header */}
      <Header />
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative py-20 md:py-28 w-full bg-gradient-to-br from-slate-950 via-blue-950 to-cyan-950 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 w-48 h-48 bg-gradient-to-t from-indigo-600/15 to-blue-600/15 rounded-full blur-2xl transform -translate-x-24 -translate-y-24"></div>

          <div className="relative w-full max-w-7xl mx-auto px-6 text-center">
            <div className="inline-flex items-center rounded-full border border-blue-700/50 bg-slate-800/50 backdrop-blur-sm px-4 py-1.5 text-sm font-medium mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto">
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 hover:from-blue-500 hover:via-indigo-500 hover:to-cyan-500 text-white shadow-xl hover:shadow-2xl transition-all duration-200 hover:scale-105 w-full sm:w-auto"
              >
                Start for free
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="border-blue-600/50 text-slate-300 hover:bg-blue-800/30 hover:text-white hover:border-blue-500 w-full sm:w-auto"
              >
                Watch demo
              </Button>
            </div>
            ...
            <div className="mt-16 relative w-full max-w-4xl mx-auto">
              <div className="absolute inset-0 -z-10 bg-gradient-to-b from-blue-600/30 via-indigo-600/20 to-cyan-600/30 rounded-3xl blur-3xl" />
        ...
        {/* CTA Section */}
        <section className="w-full bg-gradient-to-r from-blue-950 via-indigo-950 to-cyan-950 py-20 relative overflow-hidden">
          {/* Decorative elements */}
          <div className="absolute top-0 left-0 w-64 h-64 bg-gradient-to-br from-blue-600/20 to-indigo-600/20 rounded-full blur-2xl -translate-x-32 -translate-y-32"></div>
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tl from-cyan-600/20 to-blue-600/20 rounded-full blur-2xl translate-x-40 translate-y-40"></div>

          <div className="relative w-full max-w-7xl mx-auto px-6 text-center text-white">
            <div className="rounded-2xl px-8 py-16 md:px-16 bg-slate-950/20 backdrop-blur-sm border border-blue-700/30">
              <h2 className="text-3xl font-bold sm:text-4xl mb-4 bg-gradient-to-r from-white via-blue-200 to-cyan-200 bg-clip-text text-transparent">
      ...
      {/* Footer */}
      <footer className="w-full border-t border-blue-800/30 bg-gradient-to-b from-slate-950 to-blue-950/50 py-12">
