...
export default function ProfilePage() {
    return (
        <div className="min-h-screen p-6 pt-0 bg-gradient-to-br from-blue-950 via-indigo-950 to-cyan-900 text-slate-200 relative overflow-hidden w-full">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-950/25 via-indigo-900/15 to-cyan-800/25" ></div>
            <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-br from-blue-600/15 to-indigo-600/15 rounded-full blur-3xl" ></div>
            <div className="absolute bottom-24 right-10 w-80 h-80 bg-gradient-to-bl from-cyan-500/15 to-blue-700/15 rounded-full blur-3xl" ></div>
            <div className="absolute top-1/2 left-1/2 w-48 h-48 bg-gradient-to-t from-indigo-600/10 to-cyan-600/10 rounded-full blur-2xl transform -translate-x-1/2 -translate-y-1/2" ></div>
            ...
            <div className="relative container max-w-5xl py-10 md:py-14 px-4 md:px-6 w-full z-10">
                ...
                <TabsList className="grid w-full grid-cols-2 md:grid-cols-2 mb-8 bg-gradient-to-r from-blue-900/70 via-indigo-800/50 to-cyan-700/40 border border-cyan-600/30 backdrop-blur-sm shadow-xl ring-1 ring-cyan-500/10">
                    ...
                    >
                        {tab === "account" ? "Account Settings" : tab[0].toUpperCase() + tab.slice(1)}
                    </TabsTrigger>
                    ))}
                </TabsList>
