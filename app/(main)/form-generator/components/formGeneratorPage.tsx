...
export default function FormGeneratorPage() {
    ...
    return (
        <div className=
        "min-h-screen w-full  bg-gradient-to-r from-slate-900/60 via-blue-900/40 to-cyan-900/40 relative overflow-hidden flex flex-col"
        >
        ...
        <div className=
            "absolute top-1/2 left-1/2 w-48 h-48 bg-gradient-to-t from-indigo-600/15 to-cyan-600/15 rounded-full blur-2xl transform -translate-x-24 -translate-y-24"
        ></div>
