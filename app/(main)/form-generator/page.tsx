...
export default function FormGeneratorPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-violet-900 to-indigo-900 relative overflow-hidden flex flex-col">
        ...
        {generatedForm && (
          <div className="max-w-4xl mx-auto">
            <div className="w-full flex justify-end gap-3 mb-4">
              <Button
                variant="outline"
                className="border-violet-600/50 text-violet-300 hover:bg-violet-800/30 hover:text-violet-200 hover:border-violet-500"
                onClick={() => setShowPublishDialog(true)}
              >
                {isPublishing ? <Loader2 className="animate-spin text-violet-300" /> : "Publish Form"}
              </Button>
              <Button
                variant="outline"
                className="border-violet-600/50 text-violet-300 hover:bg-violet-800/30 hover:text-violet-200 hover:border-violet-500"
      ...
      <div className="relative px-4 pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-3xl lg:text-4xl xl:text-5xl mb-2 font-bold bg-gradient-to-r from-violet-300 via-indigo-300 to-purple-300 bg-clip-text text-transparent">
              Form Generator
            </h1>
          ...
          <motion.div
            ...
            className="border-2 border-violet-700/50 shadow-violet-500/40 shadow-2xl bg-slate-800/50 backdrop-blur-sm p-4 rounded-4xl transition duration-200 hover:shadow-violet-500/70"
          >
            <textarea
            ...
            <div className="flex gap-2 items-center justify-end">
              <Button
                variant="outline"
                size="icon"
                className="rounded-full w-12 h-12 border-violet-600/50 hover:bg-violet-800/30 hover:text-violet-300 text-violet-400"
                onClick={() => {
              ...
              <Button
                ...
                className={`rounded-full w-12 h-12 bg-gradient-to-r from-violet-600 via-indigo-600 to-purple-600 hover:from-violet-500 hover:via-indigo-500 hover:to-purple-500 shadow-xl hover:shadow-2xl transition-all duration-200 hover:scale-105 ${
      ...
      <Dialog open={showPublishDialog} onOpenChange={setShowPublishDialog}>
        <DialogContent className="sm:max-w-md bg-slate-800/95 border-violet-700/50 backdrop-blur-sm">
          <DialogHeader>
            <DialogTitle className="text-violet-300">Publish Form</DialogTitle>
          ...
          <div className="space-y-6 py-4">
            ...
            {!isPublic && (
              <div className="space-y-3 pt-2">
                ...
                <div className="border border-violet-700/30 rounded-md p-4 bg-slate-900/50">
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-2">
                      <Input
                        ...
                        className={`bg-slate-800/50 border-violet-700/50 text-slate-300 placeholder:text-slate-500 ${
                      ...
                      {emails.length > 0 ? (
                        <div className="space-y-2">
                          {emails.map((email) => (
                            <div
                              key={email}
                              className="flex items-center justify-between bg-violet-900/30 border border-violet-700/30 rounded-md px-3 py-2"
                            >
                              <div className="flex items-center gap-2">
                              ...
                              <Button
                                ...
                                className="h-6 w-6 p-0 hover:bg-violet-800/30"
                              >
